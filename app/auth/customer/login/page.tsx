        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-300">
              Access your startup dashboard and track your progress
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-slate-300 text-sm">
                ...
                <Link href="/auth/customer/register" className="text-amber-400 hover:text-amber-300 font-medium">
                  Register here
                </Link>
              </p>
              <p className="text-slate-400 text-xs mt-2">
                Are you a partner?{" "}
                <Link href="/auth/partner/login" className="text-blue-400 hover:text-blue-300">
                  Partner Login
                </Link>
              </p>
            </div>
