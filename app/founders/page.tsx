...
import { CheckCircle2, Lightbulb, TrendingUp, Users, Target, Layers, Globe, Zap } from 'lucide-react';
...
function NeuralRaysBackground() {
  ...
  return (
    <canvas
      ...
      style={{ background: 'radial-gradient(circle at 30% 30%, #0f1233, #090b20 70%)' }}
    />
  );
}
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-32 text-center">
      <div className="max-w-5xl mx-auto z-10">
        ...
        >
          StartupRunway is not just another consultancy — it’s India’s Startup Innovation Hub.
          We combine business strategy, SaaS automation, and AI cloud infrastructure to help founders execute faster and smarter.
        </motion.p>
    ...
    <section className="py-24 px-4 relative text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
          Build Smarter. Scale Faster. <span className="text-[#1db954]">With StartupRunway</span>
        </h2>
        <p className="text-lg text-gray-300 mb-10">
          Join India’s most connected innovation hub — where business strategy meets automation and cloud technology.
        </p>
        <Button className="bg-[#1db954] hover:bg-[#1db954]/90 text-white px-8 py-6 rounded-full">
