      ...
      <div className="w-full">
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-sm border-b border-slate-800">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            >
              <img src="/images/startuprunway-logo.png" alt="StartupRunway" className="h-7 w-7 mr-3" />
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <div className="relative group">
            ...
            <div className="absolute bottom-full right-100 mb-2 px-3 py-2 bg-slate-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-[9999]">
              Join StartupRunway
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight">
                StartupRunway – One-Stop Startup Hub SaaS-Powered Solutions for Every Stage and Your Trusted Partner in Startup Success
              </h1>
	...
	<section className="bg-slate-900 text-white py-16 px-6">
	  ...
	  <div className="bg-slate-800 p-6 rounded-xl shadow-lg">
		...
		{/*
	      ...
	      <div className="bg-slate-800 p-6 rounded-xl shadow-lg">
	        <h3 className="text-2xl font-semibold mb-4 text-amber-400">Unitversities/ R&D Collaboration</h3>
	        <ul className="text-slate-300 mb-6 space-y-2">
	          <li>E-Centers</li>
