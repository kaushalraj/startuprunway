	...
	<section className="relative min-h-screen py-16 flex items-center justify-center px-4 text-center">
      <div className="max-w-4xl py-4 mx-auto z-10">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#ff6b35] via-[#4a90e2] to-[#8b5cf6] bg-clip-text text-transparent"
        >
  ...
  return (
    <section className="py-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Who can be a Partner with StartupRunway
        </motion.h2>
